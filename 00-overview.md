...
- [week 01 numpy from scratch](./curriculum/week-01-numpy-from-scratch/00-overview.md)
- [week 02 pandas honestly](./curriculum/week-02-pandas-honestly/00-overview.md)
- [week 03 visualization that doesnt lie](./curriculum/week-03-visualization-that-doesnt-lie/00-overview.md)
- [week 04 ml workflow and linear models](./curriculum/week-04-ml-workflow-and-linear-models/00-overview.md)
- [week 05 trees forests boosting](./curriculum/week-05-trees-forests-boosting/00-overview.md)
- [week 06 clustering and dimensionality reduction](./curriculum/week-06-clustering-and-dimensionality-reduction/00-overview.md)
- [week 07 neural networks from scratch](./curriculum/week-07-neural-networks-from-scratch/00-overview.md)
- [week 08 pytorch fundamentals](./curriculum/week-08-pytorch-fundamentals/00-overview.md)
- [week 09 cnns and transfer learning](./curriculum/week-09-cnns-and-transfer-learning/00-overview.md)
- [week 10 sequence models rnn lstm gru](./curriculum/week-10-sequence-models-rnn-lstm-gru/00-overview.md)
- [week 11 attention transformers and mini gpt](./curriculum/week-11-attention-transformers-and-mini-gpt/00-overview.md)
- [week 12 capstone end to end ml with deploy](./curriculum/week-12-capstone-end-to-end-ml-with-deploy/00-overview.md)
