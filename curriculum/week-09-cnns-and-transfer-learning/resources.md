...
- **LeCun's older 2020 edition** (still available; some learners prefer the longer lectures):
...
- **Andrej Karpathy — "Stanford CS231n Winter 2016 Lecture 7" on convolutional networks** (the lecture learners rewatch):
