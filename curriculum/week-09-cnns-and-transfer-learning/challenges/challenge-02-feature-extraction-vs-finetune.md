...
- Add a **fourth variant**: full fine-tune with `backbone_lr=1e-3, head_lr=1e-3` (same LR everywhere). This is what learners do by default; the result is usually *worse* than feature extraction. Show empirically why differential learning rates are not optional.
