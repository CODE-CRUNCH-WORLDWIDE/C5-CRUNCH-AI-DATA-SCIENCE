...
- Watch **Andrej Karpathy's CS231n lecture on convolutional networks** (the 2016 recording is still free on YouTube). Karpathy was a learner when the lecture was recorded; the explanation of weight sharing at minute 15 is the cleanest version on the internet.
