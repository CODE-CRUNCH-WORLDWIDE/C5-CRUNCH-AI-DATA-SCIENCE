...
The C5 conviction: learners who fill out the self-grade honestly are the same learners who write good reports. Submission without a self-grade is not strictly penalized, but the grader will assume the absence is for a reason.
