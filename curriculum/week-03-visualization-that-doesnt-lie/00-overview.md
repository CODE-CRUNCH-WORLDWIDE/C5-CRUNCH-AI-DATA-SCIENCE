...
| [resources.md](./01-resources.md) | Free docs for matplotlib / seaborn / plotly; the FT chart-style notes |
| [lecture-notes/01-matplotlib-fundamentals.md](./02-lecture-notes/01-matplotlib-fundamentals.md) | Figure/Axes model; pyplot vs OO; first publication-quality chart |
| [lecture-notes/02-when-to-use-seaborn-vs-plotly.md](./02-lecture-notes/02-when-to-use-seaborn-vs-plotly.md) | Task-by-task picker between matplotlib, seaborn, and plotly |
| [lecture-notes/03-perceptual-encoding-and-not-lying.md](./02-lecture-notes/03-perceptual-encoding-and-not-lying.md) | Cleveland and McGill; color; axis honesty; the four common lies |
| [exercises/README.md](./03-exercises/00-overview.md) | Index of exercises |
| [exercises/exercise-01-figure-and-axes.py](./03-exercises/exercise-01-figure-and-axes.py) | Build a 2×2 subplot grid; label every axis; ship a PNG |
| [exercises/exercise-02-distributions-and-relationships.py](./03-exercises/exercise-02-distributions-and-relationships.py) | Histogram, KDE, scatter, hexbin — pick the right one for the question |
| [exercises/exercise-03-time-series.py](./03-exercises/exercise-03-time-series.py) | A line chart with a sensible date axis, annotation, and a caption |
| [challenges/README.md](./04-challenges/00-overview.md) | Index of weekly challenges |
| [challenges/challenge-01-recreate-an-FT-chart.md](./04-challenges/challenge-01-recreate-an-FT-chart.md) | Recreate a Financial Times chart with synthetic data, side-by-side |
...
| [mini-project/README.md](./07-mini-project/00-overview.md) | Full spec for the chart-recreation-and-critique project |
