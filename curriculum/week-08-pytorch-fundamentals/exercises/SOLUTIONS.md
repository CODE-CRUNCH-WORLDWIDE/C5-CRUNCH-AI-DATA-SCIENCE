...
The solutions are written exactly as a strong C5 learner should write them. Production code would add docstrings, logging, and a few more guards; the exercises are deliberately minimal.
