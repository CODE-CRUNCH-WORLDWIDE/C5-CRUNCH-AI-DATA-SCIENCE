...
If you do the [challenge](./04-challenges/challenge-01-feature-importance-vs-shap.md), this problem becomes a 15-minute extension of it on a different dataset.
...
When done, push your Week 5 repo and start (or finish) the [challenge](./04-challenges/) and the [mini-project](./07-mini-project/00-overview.md).
