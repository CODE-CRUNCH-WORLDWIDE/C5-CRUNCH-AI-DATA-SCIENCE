...
| [resources.md](./01-resources.md) | Free books, official docs, MIT linear algebra OCW |
| [lecture-notes/01-the-ndarray-and-why-it-exists.md](./02-lecture-notes/01-the-ndarray-and-why-it-exists.md) | The array object: memory, dtype, strides, views |
| [lecture-notes/02-vectorization-broadcasting-views.md](./02-lecture-notes/02-vectorization-broadcasting-views.md) | Vectorization, broadcasting, ufuncs, reductions, `einsum` |
| [exercises/README.md](./03-exercises/00-overview.md) | Index of exercises |
| [exercises/exercise-01-shape-dtype-strides.py](./03-exercises/exercise-01-shape-dtype-strides.py) | Inspect and reshape arrays; predict view vs copy |
| [exercises/exercise-02-broadcasting-drills.py](./03-exercises/exercise-02-broadcasting-drills.py) | Six broadcasting drills, each replacing a Python loop |
| [exercises/exercise-03-image-as-array.py](./03-exercises/exercise-03-image-as-array.py) | Load an image; manipulate it as a 3-D array |
| [challenges/README.md](./04-challenges/00-overview.md) | Index of weekly challenges |
| [challenges/challenge-01-image-filter-pure-numpy.md](./04-challenges/challenge-01-image-filter-pure-numpy.md) | Grayscale, box blur, Sobel edge — all pure NumPy |
...
| [mini-project/README.md](./07-mini-project/00-overview.md) | Full spec for the vectorized image-processing notebook |
