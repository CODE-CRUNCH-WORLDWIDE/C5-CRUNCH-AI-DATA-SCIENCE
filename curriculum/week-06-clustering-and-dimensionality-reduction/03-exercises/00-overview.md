...
All three should pass before you move to the [homework](../06-homework.md), the [challenge](../04-challenges/), and the [mini-project](../07-mini-project/00-overview.md).
...
On macOS arm64, `umap-learn`'s transitive dependency on `numba` is large (~50 MB) and slow to install the first time. See [resources.md](../01-resources.md) for the installation notes.
